...
urlpatterns = [
    ...
    path('view/<int:pk>/update', views.PictureUpdateView.as_view(), name='picture-update'),
	path('view/<int:pk>/delete', views.PictureDeleteView.as_view(), name='picture-delete')
]